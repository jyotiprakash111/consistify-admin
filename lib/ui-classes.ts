...
export const input = `rounded-xl border border-slate-300 bg-white px-3 py-2.5 text-sm text-slate-900 shadow-sm ring-1 ring-slate-200/80 placeholder:text-slate-400 focus:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 dark:border-zinc-600 dark:bg-zinc-950 dark:text-zinc-100 dark:ring-zinc-700/80 dark:placeholder:text-zinc-500 dark:focus:border-indigo-400 dark:focus:ring-indigo-400/25 ${t}`;
/** Input inside a bordered shell (combobox, fused search) — no own border/ring */
export const inputEmbedded =
  `min-w-0 flex-1 w-full rounded-none border-0 bg-transparent px-0 py-0 text-sm text-slate-900 shadow-none ring-0 outline-none placeholder:text-slate-400 focus:border-0 focus:outline-none focus:ring-0 dark:text-zinc-100 dark:placeholder:text-zinc-500 ${t}`;
/** Outer shell for combobox / fused controls — single border, focus ring on focus only */
export const inputShell =
  `flex min-h-[42px] items-center gap-2 rounded-xl border border-slate-300 bg-white px-3 py-2.5 shadow-sm focus-within:border-indigo-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-indigo-500/20 dark:border-zinc-600 dark:bg-zinc-950 dark:focus-within:border-indigo-400 dark:focus-within:ring-indigo-400/25 ${t}`;
export const selectEmbedded =
  `${inputEmbedded} appearance-auto cursor-pointer disabled:cursor-not-allowed disabled:opacity-50`;
